...
describe ApplicationController do
  ...
  describe 'index action' do
    context 'logged in' do
      it 'lets a user view her and her following tweets index if logged in' do
        ...
        # instead having a logged in user to see all tweets, the user can see only her own tweets and her following tweets
        user1.follow(user2)
        # refresh the page
        visit "/tweets"
